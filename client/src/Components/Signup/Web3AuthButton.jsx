...
import { Wallet, HelpCircle, Lock, Vote, CheckCircle2, User, LogOut, Info, ArrowRight } from 'lucide-react';
        ...
        <div className="w-full animate-in fade-in duration-300">
            ...
            <div className="space-y-3 mb-6">
                <button
                    ...
                    className="w-full bg-white hover:bg-slate-50 border border-[#E2E8F0] text-[#0B1527] rounded-xl py-3.5 px-4 font-semibold text-[15px] flex items-center justify-center gap-3 transition-colors shadow-sm"
                >
                    <Info className="w-4 h-4 text-[#1D58E9]" />
                    Get User Info
                </button>
            ...
            <div className="space-y-4 mb-6">
                <div className="p-4 bg-white border border-[#E2E8F0] rounded-xl shadow-sm">
                    <h3 className="font-semibold text-sm mb-3">Testing Capabilities</h3>
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-[#64748B] text-[15px] leading-relaxed mb-8 px-2">
                            {!isConnected
                                ...
                                : 'Manage your connected wallet and test Web3Auth utility functions.'}
                        </p>
                    </div>
